...
public:
    ...
    Node* singleLeftRotation(Node *parentNode, bool isLeftChild);
    Node* singleRightRotation(Node *parentNode, bool isLeftChild);
    Node* leftRightRotation(Node *parentNode, bool isLeftChild);
    Node* rightLeftRotation(Node *parentNode, bool isLeftChild);
